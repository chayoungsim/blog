...
//tsconfig.json
{
    ...
    "compilerOptions": {
        ...
        // null 값을 null 타입 이외의 타입의 변수에 할당하는 것을 금지할지 허락할지 여부를 결정하는 옵션입니다
        // false로 설정해 이 옵션을 끌 경우 어떤 타입의 변수든 null 값을 자유롭게 할당할 수 있습니다.
        // 이 옵션은 안전한 타입스크립트 코드를 작성하는 측면에서는 그닥 큰 도움이 되지는 않으니 지금은 true로 설정하거나 아예 옵션 설정을 지우겠습니다.
